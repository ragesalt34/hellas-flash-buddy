...
const translations: Translations = {
  ...
  'rd.extra': { ru: 'доп. показатель', el: 'επιπλέον δείκτης' },
  ...
  'landing.foot.title': {
    ru: 'Паспорт начинается с первого ответа.',
    el: 'Το διαβατήριο ξεκινά από την πρώτη απάντηση.',
  },
  'landing.foot.sub': {
    ru: 'Бесплатно и без регистрации. Вопросы — те самые, что задают на собеседовании.',
    el: 'Δωρεάν και χωρίς εγγραφή. Οι ερωτήσεις είναι αυτές που γίνονται στη συνέντευξη.',
  },
  'landing.foot.cta': { ru: 'Начни бесплатно', el: 'Ξεκίνα δωρεάν' },

  // Pull-quote: the ancient proverb stays in Greek in both languages; the line
  // under it translates it and ties it to the ten-minute habit.
  'landing.quote': {
    ru: 'Αρχή ήμισυ παντός.',
    el: 'Αρχή ήμισυ παντός.',
  },
  'landing.quote.sub': {
    ru: '«Начало — половина всего», — говорили древние греки.\nДесять минут сегодня — и половина пути уже позади.',
    el: '«Η αρχή είναι το ήμισυ του παντός», έλεγαν οι αρχαίοι.\nΔέκα λεπτά σήμερα — και ο μισός δρόμος έχει ήδη γίνει.',
  },
