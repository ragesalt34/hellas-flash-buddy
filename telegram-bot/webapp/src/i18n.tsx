...
const translations: Translations = {
  ...
  // Считается только по тестам, поэтому и названо так: карточки и словарь
  // в эту цифру не входят, а «успех» без уточнения читался как общий.
  'stats.accuracy': { ru: 'в тестах', el: 'στα κουίζ' },
