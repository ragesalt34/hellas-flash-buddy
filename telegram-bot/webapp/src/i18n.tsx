...
const translations: Translations = {
  ...
  'landing.quote': {
    ru: 'Экзамен сдают не зубрёжкой,\nа привычкой.',
    el: 'Τις εξετάσεις δεν τις περνάς με παπαγαλία,\nτις περνάς με συνήθεια.',
  },
  'landing.quote.sub': {
    ru: '10 минут в день бьют ночь перед экзаменом.',
    el: '10 λεπτά την ημέρα νικούν το ξενύχτι πριν την εξέταση.',
  },

  // FAQ — plain answers, real personality
  'landing.faq.title': { ru: 'Коротко о главном', el: 'Εν συντομία' },
  'landing.faq.q1': { ru: 'Это правда бесплатно?', el: 'Είναι όντως δωρεάν;' },
  'landing.faq.a1': {
    ru: 'Да, полностью. Без карты, без подписки, без «премиума».',
    el: 'Ναι, εντελώς. Χωρίς κάρτα, χωρίς συνδρομή, χωρίς «premium».',
  },
  'landing.faq.q2': { ru: 'Нужна регистрация?', el: 'Χρειάζεται εγγραφή;' },
  'landing.faq.a2': {
    ru: 'Нет. Заходишь гостем и сразу учишься. Аккаунт — только чтобы сохранять прогресс между устройствами.',
    el: 'Όχι. Μπαίνεις ως επισκέπτης και ξεκινάς αμέσως. Ο λογαριασμός είναι μόνο για να κρατάς την πρόοδο ανάμεσα σε συσκευές.',
  },
  'landing.faq.q3': { ru: 'Вопросы настоящие?', el: 'Οι ερωτήσεις είναι αληθινές;' },
  'landing.faq.a3': {
    ru: 'Да — из реального банка экзамена на гражданство: история, культура, законы, география.',
    el: 'Ναι — από την πραγματική τράπεζα της εξέτασης ιθαγένειας: ιστορία, πολιτισμός, νομοθεσία, γεωγραφία.',
  },
  'landing.faq.q4': { ru: 'А язык?', el: 'Και η γλώσσα;' },
  'landing.faq.a4': {
    ru: 'Русский и греческий — переключаются одним тапом, а греческие слова ещё и озвучены живым голосом.',
    el: 'Ρωσικά και ελληνικά — εναλλαγή με ένα άγγιγμα, και οι ελληνικές λέξεις έχουν και φωνή.',
  },
};
