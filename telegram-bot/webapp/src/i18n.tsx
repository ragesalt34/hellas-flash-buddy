...
const translations: Translations = {
  ...
  'landing.faq.a3': {
    ru: 'Да — реальные темы собеседования на гражданство: история, культура, законы, география.',
    el: 'Ναι — πραγματικά θέματα της συνέντευξης ιθαγένειας: ιστορία, πολιτισμός, νομοθεσία, γεωγραφία.',
  },
