...
const AI_ACTIONS = [
  { id: 'improve', label: 'Улучшить текст', prompt: 'Улучши и отредактируй следующий текст, сделай его более понятным и структурированным. Сохрани всю важную информацию. Верни только улучшенный текст без пояснений:' },
  { id: 'expand', label: 'Расширить', prompt: 'Расширь и дополни следующий текст дополнительными деталями и примерами. Верни только расширенный текст без пояснений:' },
  { id: 'shorten', label: 'Сократить', prompt: 'Сократи следующий текст, сохранив ключевую информацию. Верни только сокращённый текст без пояснений:' },
  { id: 'format', label: 'Форматировать', prompt: 'Отформатируй следующий текст: добавь структуру, списки где уместно, выдели ключевые моменты. Верни только отформатированный текст без пояснений:' },
  { id: 'fix', label: 'Исправить ошибки', prompt: 'Исправь грамматические и орфографические ошибки в следующем тексте. Верни только исправленный текст без пояснений:' },
];
