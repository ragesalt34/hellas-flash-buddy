...
const translations: Translations = {
  ...
  // Quiz
  'quiz.title': { ru: 'Тест', el: 'Κουίζ' },
  'quiz.finish': { ru: 'Завершить тест', el: 'Τερματισμός τεστ' },
  'quiz.question': { ru: 'Вопрос', el: 'Ερώτηση' },
  'quiz.passed': { ru: 'пройдено', el: 'ολοκληρώθηκε' },
  'quiz.chooseAnswer': { ru: 'Выберите правильный ответ', el: 'Επιλέξτε τη σωστή απάντηση' },
  'quiz.keyboardHint': { ru: 'Используйте [1, 2, 3, 4] для выбора • [Enter] для продолжения', el: 'Χρησιμοποιήστε [1, 2, 3, 4] για επιλογή • [Enter] για συνέχεια' },
  ...
  // AI Assistant
  'ai.title': { ru: 'AI Ассистент', el: 'AI Βοηθός' },
  'ai.placeholder': { ru: 'Спросите о гражданстве, визах...', el: 'Ρωτήστε για ιθαγένεια, βίζες...' },
  'ai.greeting': { ru: 'Привет! Я помогу ответить на вопросы о гражданстве Греции, визах и процедурах.', el: 'Γεια! Θα σας βοηθήσω να απαντήσετε σε ερωτήσεις σχετικά με την ελληνική ιθαγένεια, τις βίζες και τις διαδικασίες.' },
};
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  const [language, setLanguage] = useState<Language>(() => {
    ...
    return (saved === 'ru' || saved === 'el') ? saved : 'ru';
  });
